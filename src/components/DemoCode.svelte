<script>
    ...
    const parse = (code) => {
        return code.replace('$lib/core', 'svelte-flextable')
    }
                ...
                {#if component.components}
                    <ul>
                        {#each component.components as subComponent}
                            <li class:active={subComponent.name === active} on:click={() => setActive(subComponent)}>
                                <i>{@html icon}</i>
                            ...
                            <ul>
                                {#each subComponent.components as subsubComponent}
                                    <li class:active={subsubComponent.name === active} on:click={() => setActive(subsubComponent)}>
                                        <i>{@html icon}</i>
